                    ...
                    <td style="width: 50%; vertical-align: top; padding-right: 20px;">
                        <table border="0" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;">{{ $invoice->customer->address }}</td>
                            </tr>
                            <tr>
                                <td></td>
                            </tr>
                    ...
                    <td style="width: 50%; vertical-align: top; padding-left: 20px;">
                        <table border="0" style="width: 100%; border-collapse: collapse;">
                            <tr>
                                ...
                                <td class="titik-dua">:</td>
                                <td style="width: 150px; text-align: center;">{{ $invoice->invoice_number}}</td>
                            </tr>
                            <tr>
                                <td><strong>DATE</strong></td>
                                <td class="titik-dua">:</td>
                                <td style="text-align: center;">{{\Carbon\Carbon::parse($receipt->invoice->invoice_date)->translatedFormat('l, d M Y')}}</td>
                            </tr>
                            <tr>
                                <td><strong>PO #</strong></td>
                                <td class="titik-dua">:</td>
                                <td style="text-align: center;">{{ $invoice->po_number }}</td>
                            </tr>
                            <tr>
                    ...
                    @for ($i = 0; $i < $TOTAL_ROWS; $i++)
                        @if ($i < $dataCount)
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; padding-right: 5px;">{{ number_format($item->unit_price, 0, ',', '.') }}</td>
                                <td style="text-align: right; padding-right: 5px;">{{ number_format($item->quantity * $item->unit_price, 0, ',', '.') }}</td>
                            </tr>
                        @else
                            <tr>
                                <td>&nbsp;</td>
                                ...
                                <td style="width: 150px; padding: 0;">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
                                        <tr>
                                            ...
                                            <td style="text-align: right; border: none;">{{ number_format($invoice->subtotal, 0, ',', '.') }}</td>
                                        </tr>
                                    </table>
                        ...
                        <tr>
                                ...
                                <td style="width: 150px; padding: 0;">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
                                        <tr>
                                            <td style="text-align: left; border: none;">RP</td>
                                            <td style="text-align: right; border: none;">{{ number_format($invoice->discount_percentage, 0, ',', '.') }}</td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td style="width: 150px; padding: 0;">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; border: 1.5px solid black;">
                                        <tr>
                                            <td style="text-align: left; border: none;">RP</td>
                                            <td style="text-align: right; border: none;"><strong>{{ number_format($invoice->total_amount, 0, ',', '.') }}</strong></td>
                                        </tr>
                                    </table>
                ...
                <tr>
                        ...
                        <table border="0" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="font-size: 11px; line-height: 1.5;">
                                    ...
                                    <strong>{{ $company->bank_account_number }}</strong>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td style="width: 40%; vertical-align: top; text-align: center;">
                        ...
                        <table border="0" style="width: 100%; border-collapse: collapse; text-align: center;">
                            <tr>
                                <td style="font-size: 11px; height: 10px;">{{ $company->city}}, {{\Carbon\Carbon::parse($receipt->invoice->invoice_date)->format('d M Y')}}</td>
                            </tr>
                            <tr>
                                <td style="font-size: 11px; height: 10px; font-weight: bold; padding-bottom: 75px;">{{\Illuminate\Support\Str::upper($company->name)}}</td>
                            </tr>
                            <tr>
                                <td style="font-size: 11px; font-weight: bold; text-decoration: underline;">{{$company->director_name}}</td>
                            </tr>
                            <tr>
    ...
    <div class="receipt-page">
        <div class="container">
            <table class="table-receipt" border="0">
                <tr>
                   <td style="width: 75%;">
                        <img src="{{ public_path('storage/01KWP25EFPZM0BVGB1ZT42FBAB.png') }}" alt="" style="width: 100px; height: auto;">
                    </td>
                    <td colspan="4">
                        <table class="table-right" style="width: 100%;">
                            <tr>
                                <td>{{\Illuminate\Support\Str::upper($company->name)}}</td>
                            </tr>
                            <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right; white-space:nowrap; width: 100px; border: 1px solid black; height:15px; font-size: 11px; font-weight: bold;">{{ $receipt->receipt_number }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="titik-dua">:</td>
                    <td colspan="3" style="font-size: 12px;"><strong>{{ $receipt->invoice->customer->name }}</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="titik-dua">:</td>
                    <td colspan="3" rowspan="2" style="font-size: 12px; border: 1px solid black; border-bottom: 1px solid black; background-color: #f2f2f2;">{{ $receipt->amount_in_words }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="titik-dua">:</td>
                    <td colspan="3" style="font-size: 12px;">{{ $receipt->invoice->order->name }}</td>
                </tr>
                <tr>
            ...
            <table style="width: 100%; padding:0; border-collapse:collapse; margin-top:10px; text-align: center;" border="0">
                <tr style="margin:0;">
                    ...
                    <td style="width: 30%; height:10px;" ><span>{{$company->city}}, {{\Carbon\Carbon::parse($receipt->invoice->invoice_date)->format('d M Y')}}</span></td>
                </tr>
                <tr style="margin:0;">
                    <td colspan="2" style="width: 30%; height:10px;"></td>
                    <td style="width: 30%; height:10px;">{{\Illuminate\Support\Str::upper($company->name)}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="font-size: 14px; text-align:center; border: 1px solid black; background-color: #f2f2f2;"><strong>Rp. {{ number_format($receipt->amount, 0, ',', '.') }}</strong></td>
                    <td></td>
                    <td style="text-decoration: underline; font-size: 11px;"><strong>{{$company->director_name}}</strong></td>
                </tr>
                <tr style="margin:0;">
                    <td colspan="2" style="width: 30%; height:10px;"></td>
